...
public class Products{
	...
	public String toString() {
		return "Products [id=" + id + ", title=" + title + ", minQuantity=" + minQuantity + ", gender=" + gender
				+ ", iconUrl=" + iconUrl + ", shortDescription=" + shortDescription + ", longDescription="
				+ longDescription + ", productName=" + productName + ", productCategory=" + productCategory
				+ ", inventryStatus=" + inventryStatus + ", availableQuantity=" + availableQuantity + ", purchasable="
				+ purchasable + ", searchTags=" + searchTags + ", model=" + model + ", brand=" + brand
				+ ", specification=" + specification + ", warrantyDuration=" + warrantyDuration + ", imageUrls="
				+ imageUrls + ", orderLimit=" + orderLimit + ", returnDates=" + returnDates + ", length=" + length
				+ ", width=" + width + ", height=" + height + ", weight=" + weight + ", ratings=" + ratings
				+ ", isElegibileForPromotion=" + isElegibileForPromotion + ", discount=" + discount + ", isHazardous="
				+ isHazardous + ", isReturnable=" + isReturnable + "]";
	}
